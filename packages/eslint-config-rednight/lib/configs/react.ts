import {pluginJSX, pluginReact, PluginReactHooks, pluginTestingLibrary} from "../plugins";
  ...
  return [
    ...
    },
    {
      rules: {
        ...
        "react/forbid-component-props": ["warn", {forbid: [{propName: "data-test-id", message: "Please use `data-testid` instead"}]}],
        ...
        "jsx/click-events-have-key-events": "warn",
